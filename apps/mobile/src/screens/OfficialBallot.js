            ...
            return (
              <View key={race.id} style={{ marginBottom: space(5) }}>
                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                  ...
                  {pending && (
                    <View style={{ borderWidth: 1.5, borderColor: '#63305A', borderRadius: 999, paddingHorizontal: 7, paddingVertical: 1 }}>
                      <Text style={{ color: '#63305A', fontWeight: '800', fontSize: 9.5 }}>
                ...
                {pending && (
                  <Text style={{ fontSize: 11.5, color: '#63305A', fontStyle: 'italic', marginBottom: space(2) }}>
                    {S.pendingNote}
                        ...
                        >
                          ...
                          <View style={{ marginLeft: space(3), flex: 1 }}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', flexWrap: 'wrap' }}>
                              ...
                              {starred && (
                                <Text style={{ marginLeft: 8, color: '#63305A', fontWeight: '800', fontSize: 12 }}>
                                  {S.topMatch}
                                </Text>
                              )}
                            </View>
                        ...
                        {cand.researched && (
                          <View style={{ alignItems: 'flex-end', marginLeft: 6 }}>
                            {cand.researched && (
                              ...
                              >
                                <Text style={{ color: '#63305A', fontWeight: '700', fontSize: 13 }}>{S.view}</Text>
                              </Pressable>
                            )}
                          </View>
                        )}
